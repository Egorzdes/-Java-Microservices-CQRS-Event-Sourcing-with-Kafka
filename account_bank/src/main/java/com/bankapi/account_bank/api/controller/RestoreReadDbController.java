package com.bankapi.account_bank.api.controller;


import com.bank.account_common.dto.BaseResponse;
import com.bank.cqrs_core.infrastructure.CommandDispatcher;
import com.bankapi.account_bank.api.command.RestoreReadDbCommand;
...
public class RestoreReadDbController {
    ...
    public ResponseEntity<BaseResponse> restoreReadDb() {
        try {
            ...
            var safeErrorMessage = "Error while processing request read database!";
